...
export function initElements(doc = document) {
  const grouped = {
    ...
    create: {
      ...
      memoryMode: doc.getElementById('memoryMode'),
      phaseTimeoutSeconds: doc.getElementById('phaseTimeoutSeconds'),
  ...
  return {
    ...
    memoryMode: grouped.create.memoryMode,
    phaseTimeoutSeconds: grouped.create.phaseTimeoutSeconds,
